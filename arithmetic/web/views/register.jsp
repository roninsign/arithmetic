...
<center>
    ...
    <form action="${pageContext.request.contextPath}/user?state=doRegister" method="post">
        <c:if test="${language==1}">
            ...
            <strong>学&nbsp;&nbsp;&nbsp号:</strong> <input  type="text" name="studentNumber" style="height: 35px;width: 300px;margin-top:30px "  required="required" placeholder="2018146397"><br>
            <strong>密&nbsp;&nbsp;&nbsp码:</strong> <input type="password" name="password"style="height: 35px;width: 300px;margin-top: 25px" required="required" ><br>
            <input type="submit" value="注册" style="width: 100px;height: 35px;margin-top: 25px">
        </c:if>
        <c:if test="${language==2}">
            <strong>Username：</strong> <input  type="text" name="username" style="height: 35px;width: 300px;margin-top:30px "  required="required" placeholder="hjc"><br>
